...
lbl_result = QLabel("Вы ответили верно!")
...
questions = [
    Question('Сколько лет Даниилу Фотееву?', 'НЕ знаю', '22', '24', '19'),
    Question('Какая фамилия у Вики?', 'Колупаева', 'Вампирова', 'Фырова', 'Цепень'),
    Question('На что делится бюджет?', 'доходы и расходы', 'есть деньги и нет денег', 'семья и друзья', 'копилка'),
    Question('Как будет собака на польском?', 'курва', 'Польша=Россия', 'Крым наш', 'пшепрашам')
